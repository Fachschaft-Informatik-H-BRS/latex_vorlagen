...
\begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
        \centering
        \includegraphics[width=\linewidth,keepaspectratio]{2.0.0.0_content/assets/bilder/antiker_armreif_sudan_amanishakheto_in_berlin.jpg}
    \end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
        \centering
        \includegraphics[width=\linewidth,keepaspectratio]{2.0.0.0_content/assets/bilder/stained_glass_projekt_half_life_hand_made.jpeg}
    \end{column}
\end{columns}
\end{frame}
