...
\begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
        \centering
        \includegraphics[width=\linewidth,keepaspectratio]{2.0.0.0_content/assets/bilder/fenster.jpg}
    \end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
        \centering
        \includegraphics[width=\linewidth,keepaspectratio]{2.0.0.0_content/assets/bilder/schutzbrille.png}
    \end{column}
\end{columns}
\end{frame}